    ...
    <footer className="bg-gray-50 mt-auto border-t border-gray-200">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center md:text-left">
          <div>
            <h3 className="text-xl font-bold text-gray-800 mb-4">Magic PDF</h3>
            <p className="text-sm text-gray-500">Your magical toolkit for all PDF needs.</p>
          </div>
          <div>
          ...
          <div>
            ...
            <div className="flex justify-center md:justify-start space-x-6">
              <a href="#" className="text-gray-400 hover:text-blue-600 transition-transform hover:scale-110" aria-label="Github">
                <GithubIcon className="h-6 w-6" />
              </a>
              <a href="#" className="text-gray-400 hover:text-blue-600 transition-transform hover:scale-110" aria-label="Twitter">
                <TwitterIcon className="h-6 w-6" />
              </a>
              <a href="#" className="text-gray-400 hover:text-blue-600 transition-transform hover:scale-110" aria-label="LinkedIn">
